  ...
  return (
    <div className="about-me-right col-span-6 flex flex-col items-center justify-between p-6 md:p-0 md:pe-8">
      <div className="my-9 md:my-0">
        ...
        <div className="rounded-xl bg-gun-metal bg-opacity-50 px-4 py-3 md:bg-inherit lg:bg-gun-metal lg:bg-opacity-50 p-3 md:p-0 lg:px-4 lg:py-4 shadow-md md:shadow-none lg:shadow-md">
